...
load("games_version_02062025.RData")

games_combined_cleaned_final <- games_2025_included
...
shinyUI(fluidPage(
  ...
  HTML("<p>Some summary tables and plots from Turkish Super League scores from 1959 until 2024-2025.</p>"),
  ...
  wellPanel(
    ...
    sliderInput("seasons_selected", "Select Season Interval (1 = 1959 , 67 = 2024-2025)",
