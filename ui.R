...
load("games_version_05062026.RData")
...
shinyUI(fluidPage(
  ...
  HTML("<p>Some summary tables and plots from Turkish Super League scores from 1959 until 2025-2026.</p>"),
  ...
  wellPanel(
    ...
    sliderInput("seasons_selected", "Select Season Interval (1 = 1959 , 68 = 2025-2026)",
